...
public final class UrlyBirdRoomOfferService_Stub
    extends java.rmi.server.RemoteStub
    implements suncertify.common.RoomOfferService
{
    ...
    public UrlyBirdRoomOfferService_Stub(java.rmi.server.RemoteRef ref) {
	super(ref);
    }
